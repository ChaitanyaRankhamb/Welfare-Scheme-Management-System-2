...
const groq_sdk_2 = require("groq-sdk");
/**
 ...
 */
const MARATHI_PROMPT = 'हे संभाषण शुद्ध मराठी भाषेत आहे. सरकारी योजना, शेतकरी, पीएम किसान, पीक विमा, महाडीबीटी, ' +
...
const ENGLISH_PROMPT = 'Government welfare schemes, eligibility criteria, PM Kisan, farmer subsidies, scholarship, ' +
    'Ayushman Bharat, MahaDBT, ration card, income certificate, caste certificate, application process.';
const MULTILINGUAL_PROMPT = 'सरकारी योजना, शेतकरी, पीएम किसान, पीक विमा, Government welfare schemes, PM Kisan, MahaDBT, scholarship, eligibility.';
/**
 * Transcribe audio using Groq Whisper Large v3 with Marathi and English support.
 */
const audioTranscriptionService = async ({ audioBuffer, mimeType = 'audio/webm', originalName = 'audio.webm', language, prompt, }) => {
    ...
    try {
        ...
        const file = await (0, groq_sdk_2.toFile)(audioBuffer, originalName, { type: mimeType });
        ...
        const groqClient = new groq_sdk_1.Groq({ apiKey });
