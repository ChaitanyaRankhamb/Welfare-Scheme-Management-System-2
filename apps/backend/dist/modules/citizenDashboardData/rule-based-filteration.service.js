...
exports.ruleBasedFilterationService = void 0;
const ruleBasedFilterationService = async (profileData, allSchemes) => {
    return allSchemes.filter((scheme) => {
        ...
        // Income
        if (e.income) {
            if (profileData.annualIncome < e.income.min ||
        ...
        if (e.location.states.length > 0) {
            ...
            const hasState = e.location.states.some((s) => s.toLowerCase() === pState);
            if (!hasState) {
        ...
        if (e.social.caste.length > 0) {
            ...
            const hasCaste = e.social.caste.some((c) => c.toLowerCase() === pCaste || c.toLowerCase() === normalizedCaste);
            if (!hasCaste) {
        ...
        if (e.social.religion.length > 0) {
            ...
            const hasReligion = e.social.religion.some((r) => r.toLowerCase() === pReligion);
            if (!hasReligion) {
        ...
        if (e.employment.employmentStatus.length > 0) {
            ...
            const hasStatus = e.employment.employmentStatus.some((s) => s.toLowerCase() === pStatus || s.toLowerCase() === pOccupation);
            if (!hasStatus) {
...
exports.ruleBasedFilterationService = ruleBasedFilterationService;
